...
const gmModel = require(__dirname + "/models/groupmessages");
const pmModel = require(__dirname + "/models/privatemessages");
...
mongoose
  .connect(
    "mongodb+srv://mehamodi9:Jayesh21@cluster0.kqzwk7p.mongodb.net/comp3133_labtest_01?retryWrites=true&w=majority",
    {
